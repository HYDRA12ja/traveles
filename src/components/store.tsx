...
export default function Pricing4({ onBack }: Pricing4Props) {
    const pricingPlans = [
        {
            plan: 'Starter',
            price: 0,
            ...
            <div className="relative font-sans flex flex-col items-center justify-center overflow-x-hidden bg-white dark:bg-black min-h-screen">
                <div className="container mx-auto px-4 py-16 md:py-24">
                    {onBack && (
                        <button
                            onClick={onBack}
                            className="mb-8 inline-flex items-center gap-2 px-4 py-2 text-sm font-semibold text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition-colors"
