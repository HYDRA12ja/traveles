...
const Signin4: React.FC<SignupProps> = ({ onSignIn, onBack, onAuthSuccess }) => {
  ...
  return (
    <div className="flex items-center justify-center p-4 min-h-screen flex-col">
      {/* Header */}
      <header className="absolute top-0 left-0 right-0 flex flex-row justify-between items-center px-8 lg:px-16 py-8 z-20">
        {/* Logo */}
        <div
          style={{
        ...
        <div className="bg-white dark:bg-black border border-gray-200 dark:border-gray-800 rounded-lg p-8 shadow-sm">
          ...
          {onBack && (
            <button
              type="button"
              onClick={onBack}
              className="mb-6 inline-flex items-center gap-2 text-sm font-medium text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 transition-colors"
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div className="text-center mt-6">
            <p className="text-sm text-gray-600 dark:text-gray-400">
              ...
              <button 
                type="button"
                onClick={onSignIn}
                className="font-medium text-gray-900 dark:text-gray-100 underline underline-offset-4 hover:no-underline cursor-pointer"
              >
                Sign in
              </button>
            </p>
