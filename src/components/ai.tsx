...
const PromptComponent = ({ onBack }: { onBack?: () => void }) => {
  ...
  return (
    <div className="w-full min-h-screen flex flex-col bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-950 dark:to-gray-900">
      {/* Header */}
